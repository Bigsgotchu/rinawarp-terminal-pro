...
router.post('/track', trackingLimiter, async (req, res) => {
  try {
    const { event, properties = {}, userId, sessionId, context = {} } = req.body;
...
router.post('/pageview', trackingLimiter, async (req, res) => {
  try {
    const { page, title, loadTime, userId, sessionId } = req.body;
...
router.post('/click', trackingLimiter, async (req, res) => {
  try {
    const { button, text, position, userId, sessionId } = req.body;
...
router.post('/conversion', trackingLimiter, async (req, res) => {
  try {
    const { type, value, currency = 'USD', properties = {}, userId, sessionId } = req.body;
