 ...
 */
export function legacyDoctorCommandToPlanStep(cmd) {
 ...
 */
export function isLegacyCommand(cmd) {
 ...
 */
export async function doctorInspect(intent) {
 ...
 */
export async function doctorCollect(steps, streamCallback) {
...
export async function doctorVerify(input) {
    ...
    const outcome = engine.report(input.diagnosis || {}, verification, []);
    return { verification, outcome };
}
/**
 * Execute a fix plan (via registry tools)
 */
export async function doctorExecuteFix(plan, confirmed, confirmationText, streamCallback) {
    return await engine.executeFix(plan, { confirmed, confirmationText, streamCallback });
}
/**
 ...
 */
export function doctorExportTranscript(format) {
