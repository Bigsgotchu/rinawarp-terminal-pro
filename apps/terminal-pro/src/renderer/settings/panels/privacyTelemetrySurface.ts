...
export function renderPrivacyTelemetryPanel(settings: PrivacyTelemetrySettings | null): string {
  ...
  return `
    ...
    <div class="rw-card">
      ...
      <div class="rw-prose">
        <p>RinaWarp sends app version, platform, architecture, anonymous install ID, and lightweight counters such as task_started, task_completed, task_failed, rollback_triggered, and approval_denied.</p>
