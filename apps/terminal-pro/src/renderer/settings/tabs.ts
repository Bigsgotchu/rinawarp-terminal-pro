...
function attachTabClickHandlers(tabs: SettingsTab[], rail: HTMLElement, ctx: { state: InternalState; opts: SettingsTabsOptions }): void {
  for (const tab of tabs) {
...
export function initSettingsTabs(tabs: SettingsTab[], opts: SettingsTabsOptions): { selectTab: (id: SettingsTabId) => void } {
