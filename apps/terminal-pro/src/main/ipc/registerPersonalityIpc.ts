...
import { DEFAULT_PERSONA, type PersonalityStore, generatePersonalityPrefix, generatePersonalityReply } from "../../personality.js";
...
export function registerPersonalityIpc(args: {
  ...
  args.ipcMain.handle("rina:personality:reply", async (_event, payload: {
    userId: string;
    message: string;
  ...
  args.ipcMain.handle("rina:personality:prefix", async (_event, payload: {
    userId: string;
    message: string;
  }) => {
