...
5. Confirm the callback returns to `RinawarpTechnologies.rinawarp-companion`.
...
5. Confirm the browser returns to `RinawarpTechnologies.rinawarp-companion/purchase-complete`.
