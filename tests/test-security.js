...
try {
    const securityEngine = new EnhancedSecurityEngine();
...
function testPerformanceMetrics() {
    ...
    console.log(`   - Last Assessment: ${new Date(securityEngine.securityMetrics.lastThreatAssessment).toLocaleString()}`);
