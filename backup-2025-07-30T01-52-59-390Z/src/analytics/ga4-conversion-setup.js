...
class GA4ConversionSetup {
  ...
  initialize() {
    ...
    console.log('GA4 Enhanced Conversion Tracking initialized');
  }
  ...
  configureConversionTracking() {
    ...
    console.log('Conversion tracking configured for:', conversionEvents);
  }
  ...
  configureEnhancedEcommerce() {
    ...
    console.log('Enhanced ecommerce configured');
  }
  ...
  trackPrimaryConversion(conversionType, data = {}) {
    ...
    if (conversionId && conversionId.startsWith('AW-')) {
      gtag('event', 'conversion', {
        ...
        currency: 'USD',
        event_callback: () => {
          console.log(`Conversion sent to Google Ads: ${conversionType}`);
        },
      });
    }
    ...
    console.log(`GA4 Primary conversion tracked: ${conversionType}`, conversionData);
  }
  ...
  trackMicroConversion(conversionType, data = {}) {
    ...
    console.log(`GA4 Micro-conversion tracked: ${conversionType}`, conversionData);
  }
  ...
  trackPurchase(purchaseData) {
    ...
    console.log(`GA4 Purchase tracked: ${transactionId}`, purchaseData);
  }
  ...
  trackConversionPathStep(stepName, stepData = {}) {
    ...
    console.log(`GA4 Conversion path step tracked: ${stepName}`, stepData);
  }
  ...
  configureCrossDeviceTracking(userId) {
    if (userId) {
      ...
      console.log(`GA4 Cross-device tracking configured for user: ${userId}`);
    }
  }
  ...
  configureDataDrivenAttribution() {
    ...
    console.log('GA4 Data-driven attribution model configured');
  }
