...
class EnhancedConversionTracker {
  ...
  trackPrimaryConversion(conversionType, data = {}) {
    ...
    console.log(`Primary conversion tracked: ${conversionType}`, conversionEvent);
  ...
  trackMicroConversion(conversionType, data = {}) {
    ...
    console.log(`Micro conversion tracked: ${conversionType}`, conversionEvent);
  ...
  disable() {
    ...
    console.log('Enhanced conversion tracking disabled');
  }
