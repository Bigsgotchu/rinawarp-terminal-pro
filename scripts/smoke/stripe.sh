...
rg -q 'One Fix' "$TMP_DIR/pricing.html"
rg -q '\$3' "$TMP_DIR/pricing.html"
rg -q 'data-checkout-tier="fix"' "$TMP_DIR/pricing.html"
rg -q 'Pro' "$TMP_DIR/pricing.html"
rg -q '\$15' "$TMP_DIR/pricing.html"
rg -q 'data-checkout-tier="pro"' "$TMP_DIR/pricing.html"
rg -q 'Team' "$TMP_DIR/pricing.html"
rg -q '\$40' "$TMP_DIR/pricing.html"
rg -q 'data-checkout-tier="team"' "$TMP_DIR/pricing.html"
