...
class LicenseManager {
    ...
    hasFeature(feature) {
        ...
        const features = {
            ...
            'team': ['basic_ai', 'themes', 'history', 'cloud_sync', 'advanced_ai', 'custom_themes', 'team_features', 'sso_basic'],
            'enterprise': ['basic_ai', 'themes', 'history', 'cloud_sync', 'advanced_ai', 'custom_themes', 'team_features', 'sso_advanced', 'on_premise', 'custom_integrations']
        };
    ...
    getAIQueryLimit() {
        ...
        switch(tier) {
            case 'personal': return 5; // 5 per day
            case 'professional':
            case 'team':
            case 'enterprise':
            case 'trial':
            ...
            <div style="position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0,0,0,0.8); z-index: 10000; display: flex; align-items: center; justify-content: center;">
                <div style="background: white; padding: 30px; border-radius: 10px; max-width: 500px; text-align: center;">
                    ...
                    <div style="margin: 20px 0;">
                        <button onclick="window.open('https://rinawarp.com/pricing', '_blank')" style="background: #007acc; color: white; padding: 10px 20px; border: none; border-radius: 5px; margin: 5px; cursor: pointer;">View Pricing</button>
    ...
    getStatus() {
        return {
            ...
            aiQueriesRemaining: this.getAIQueryLimit() === -1 ? 'unlimited' : (this.getAIQueryLimit() - (parseInt(localStorage.getItem(`ai_usage_${new Date().toDateString()}`) || '0')))
        };
    }
}
