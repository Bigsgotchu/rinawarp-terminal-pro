...
class GlobalObjectManager {
  ...
  validateGlobals() {
    ...
    if (globalObj) {
      ...
      const commonGlobals = [
        'RinaWarpIntegration', 'rinaWarpIntegration', 'beginnerUI',
        'agentManager', 'securityDashboard', 'AIContextEngine',
        'PerformanceMonitor', 'TerminalSharing', 'WorkflowAutomation',
        'ZeroTrustSecurity', 'EnhancedSecurity', 'NextGenUI'
      ];
...
if (typeof module !== 'undefined' && module.exports) {
  module.exports = { GlobalObjectManager, globalObjectManager };
}
