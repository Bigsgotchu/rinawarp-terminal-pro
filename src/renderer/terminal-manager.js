...
export const TerminalManager = window.TerminalManager || class TerminalManager {
  constructor() {
    console.warn('Using stub TerminalManager - the real implementation should be loaded from renderer.js');
  }
};
