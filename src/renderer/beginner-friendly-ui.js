...
class BeginnerFriendlyUI {
    ...
    displayAssistantResponse(response) {
        ...
        messageDiv.innerHTML = `
            <div class="response-content">
                ...
                ${response.command ? `<div class="command-suggestion">
    ...
    setupCommandExplanations() {
        ...
        document.addEventListener('keydown', (e) => {
            if (e.key === 'Enter' && this.isBeginnerMode) {
                ...
                if (activeTerminal) {
                    const command = this.terminalManager.commandBuffers.get(this.terminalManager.activeTerminalId) || '';
                    if (command.trim()) {
    ...
    showCommandExplanation(command) {
        ...
        if (explanation) {
            this.showTooltip(explanation, command.includes('rm') || command.includes('delete') ? 'warning' : 'info');
        }
    }
            ...
            steps: [
                {
                    ...
                    content: "A terminal is a text-based interface where you type commands to interact with your computer. It might seem scary at first, but it's actually very powerful!",
                    action: "Click 'Next' to continue"
                },
                {
                    title: "The Prompt",
                    content: "The line where you type commands is called the 'prompt'. It usually shows your current directory and ends with a symbol like $ or >",
                    highlight: ".terminal",
                    action: "Look at your terminal prompt"
                },
                {
                    title: "Your First Command",
                    content: "Let's try your first command! Type 'pwd' (which stands for 'print working directory') to see where you are.",
                    command: "pwd",
                    action: "Type 'pwd' and press Enter"
                },
                {
                    title: "Listing Files",
                    content: "Now let's see what files are in your current directory. Type 'ls' to list them.",
                    command: "ls",
                    action: "Type 'ls' and press Enter"
                },
                {
                    title: "Great Job!",
                    content: "You've learned the basics! The terminal shows you information through text output. You can always ask for help by typing 'help' or clicking the help button.",
        ...
        return {
            ...
            steps: [
                ...
                },
                {
                    ...
                    content: "Use 'cd' to move into directories. Let's go into the directory we just created.",
    ...
    createGitTutorial() {
        return {
            ...
            steps: [
                {
                    title: "What is Git?",
                    content: "Git is a version control system that helps you track changes in your code and collaborate with others.",
                    action: "Let's learn Git basics!"
                },
                {
                    title: "Check Git Status",
                    content: "The most important Git command is 'git status'. It tells you what's happening in your repository.",
                    command: "git status",
    ...
    showCommandReference() {
        this.terminalManager.pluginAPI.createModal('Command Reference', `
    ...
    showShortcuts() {
        this.terminalManager.pluginAPI.createModal('Keyboard Shortcuts', `
    ...
    updateHelpContent(mode) {
        ...
        const content = {
            guided: {
                ...
                content: 'In Guided Mode, click on task categories to see common actions. Each task will walk you through the steps with helpful explanations.'
            },
            visual: {
                title: '🎨 Visual Builder Help',
                content: 'Drag command blocks from the palette to the drop zone. Commands will be automatically connected and you can preview before executing.'
            },
            traditional: {
                title: '⌨️ Enhanced Terminal Help',
                content: 'This is the classic terminal with smart enhancements. Use quick actions for common commands or enable features like auto-complete and explanations.'
            },
            expert: {
                title: '🚀 Expert Mode Help',
                content: 'Expert mode provides access to advanced features like multiple terminals, workflow automation, and cloud sync. Configure the features you need.'
            }
        };
    ...
    executeGuidedTask(task) {
        const tasks = {
            'list-files': {
                ...
                steps: [
                    { description: 'We\'ll use the "ls" command to see what files are in your current folder.', command: 'ls' },
                    { description: 'For more details, we can add the "-la" flag to see hidden files and permissions.', command: 'ls -la' }
                ]
            },
            'create-folder': {
                ...
                steps: [
                    ...
                    { description: 'Now we\'ll create a new folder called "my-new-folder".', command: 'mkdir my-new-folder' },
            ...
            'git-status': {
                title: 'Check Git Status',
                steps: [
                    { description: 'Let\'s check the current status of your Git repository.', command: 'git status' },
            ...
            'git-commit': {
                ...
                steps: [
                    ...
                    { description: 'Finally, we\'ll commit with a descriptive message.', command: 'git commit -m "Save my changes"' }
                ]
            },
            'install-deps': {
                title: 'Install Project Dependencies',
                steps: [
                    { description: 'We\'ll check if there\'s a package.json file first.', command: 'ls package.json' },
                    { description: 'Now we\'ll install all the dependencies listed in package.json.', command: 'npm install' }
                ]
            },
            'start-project': {
                title: 'Start Your Project',
                steps: [
                    { description: 'Let\'s check what scripts are available in your project.', command: 'npm run' },
...
class TaskWalkthrough {
    ...
    setupEventListeners() {
        this.modal.querySelector('#walkthrough-prev').addEventListener('click', () => this.previousStep());
