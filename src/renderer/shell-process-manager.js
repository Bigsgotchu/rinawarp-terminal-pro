...
/**
 * Factory function to create and initialize a shell manager
 */
export async function createShellManager(tabId, terminal, options = {}) {
    const manager = new ShellProcessManager(tabId, terminal, options);
    await manager.init();
    return manager;
}
