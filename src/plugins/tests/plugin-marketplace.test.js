...
describe('PluginMarketplace', () => {
  ...
  describe('searchPlugins', () => {
    it('should search for plugins successfully', async () => {
      ...
      expect(global.fetch).toHaveBeenCalledWith(
        'https://plugins.rinawarp.com/api/search?q=test'
      );
    ...
    it('should handle search errors', async () => {
      ...
      await expect(pluginMarketplace.searchPlugins('test'))
        .rejects.toThrow('Failed to search plugins: Network error');
    });
  ...
  describe('getPlugin', () => {
    ...
    it('should handle plugin not found', async () => {
      ...
      await expect(pluginMarketplace.getPlugin('nonexistent-plugin'))
        .rejects.toThrow('Failed to get plugin: Plugin not found');
    });
  });
  ...
  describe('installPlugin', () => {
    ...
    it('should handle installation errors', async () => {
      ...
      await expect(pluginMarketplace.installPlugin('nonexistent-plugin'))
        .rejects.toThrow('Failed to install plugin: Plugin not found');
    });
    ...
    it('should handle download errors', async () => {
      ...
      await expect(pluginMarketplace.installPlugin('test-plugin'))
        .rejects.toThrow('Failed to install plugin: Download failed');
    });
    ...
    it('should handle plugin loading errors', async () => {
      ...
      await expect(pluginMarketplace.installPlugin('test-plugin'))
        .rejects.toThrow('Failed to install plugin: Load failed');
    });
  ...
  describe('downloadPlugin', () => {
    ...
    it('should handle download errors', async () => {
      ...
      await expect(pluginMarketplace.downloadPlugin('https://example.com/plugin.js'))
  ...
  describe('integration scenarios', () => {
    ...
    it('should handle marketplace API errors gracefully', async () => {
      ...
      await expect(pluginMarketplace.searchPlugins('test'))
        .rejects.toThrow('Failed to search plugins: API temporarily unavailable');

      await expect(pluginMarketplace.getPlugin('test-plugin'))
        .rejects.toThrow('Failed to get plugin: API temporarily unavailable');
    });
  });
});
